...
#define DEFAULT_BOARD_NAME            "STM32"
...
#define BUFFER_LEN      128
      ...
      totalDataSize = offset + sizeof(readCheckSum) - CONFIG_EEPROM_START;
    ...
    void EEPROM_putDynamicData()
    {
      ...
      totalDataSize = offset + sizeof(checkSum) - CONFIG_EEPROM_START;
    ...
    void saveConfigData()
    {
      ...
      ESP_AT_LOGWARN5(F("SaveEEPROM,sz="), EEPROM.length(), F(",Datasz="), sizeof(ESP8266_AT_config) + totalDataSize,
                      F(",CSum="), calChecksum);
    ...
    bool getConfigData()
    {
      ...
      else
      {
        ...
        ESP_AT_LOGERROR1(F("EEPROMsz:"), EEPROM_SIZE);
        ESP_AT_LOGERROR1(F("EEPROM Length():"), EEPROM.length());
