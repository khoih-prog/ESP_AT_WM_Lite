...
// -- HTML page fragments
const char ESP_AT_HTML_HEAD_START[] /*PROGMEM*/ = "<!DOCTYPE html><html><head><title>nRF52_AT_WM_Lite</title><meta name='viewport' content='width=device-width, initial-scale=1'>";
