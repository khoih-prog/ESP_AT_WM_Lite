...
#define MAX_NUM_WIFI_RECON_TRIES_PER_LOOP     1
    ...
    void createHTML(String& root_html_template)
    {
      ...
      String ESP_AT_HTML_SCRIPT    =
        "<script id=\"jsbin-javascript\">function udVal(key,val){var request=new XMLHttpRequest();var url='/?key='+key+'&value='+encodeURIComponent(val);request.open('GET',url,false);request.send(null);}\
